// Task_1 Оценка алгосложности программы
/*
...
#include <iomanip>
 ...
 // функция вычисляет сумму разностей между членами массива 
 // последовательно перебирая массив начиная со второго элемента
 // время выполннеия функци напрямую зависит от количества данных в массиве О(n)
 // для интереса добавил прямой подсчет времени - чтобы показать что этот способ не совсем корректен
